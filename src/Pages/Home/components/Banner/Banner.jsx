...
const Banner = () => {
    ...
    return (
        <div className="background-img pt-8 md:pt-12 lg:pt-24">
            ...
            <div className='w-full lg:w-fit h-fit p-6 border bg-white bg-opacity-55 rounded-2xl mx-auto text-center'>
            ...
            <div className='mt-3 md:mt-8 lg:mt-24 mx-auto flex flex-col md:flex-row w-fit h-fit space-y-2 md:space-y-0 md:space-x-24'>
                ...
                <Link to={'/search_page'}>
                    <button className="relative inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold text-[#27ce64] transition-all duration-150 ease-in-out hover:pl-10 hover:pr-6 bg-gray-50 bg-opacity-70 group rounded-full border border-green-500">
