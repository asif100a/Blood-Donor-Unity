    ...
    return (
        <div className="background-img pt-24">
            ...
            <div className='mt-24 mx-auto w-fit h-fit space-x-24'>
                <Link to={'/register'}>
                    <button href="#_" className="relative inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold text-orange-600 transition-all duration-150 ease-in-out hover:pl-10 hover:pr-6 bg-gray-50 bg-opacity-70  group rounded-full border border-orange-600">
                ...
                <Link to={'/search_page'}>
                    <button href="#_" className="relative inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold text-[#27ce64] transition-all duration-150 ease-in-out hover:pl-10 hover:pr-6 bg-gray-50 bg-opacity-70 group rounded-full border border-green-500">
                        <span className="absolute bottom-0 left-0 w-full h-1 transition-all duration-150 ease-in-out bg-[#27ce64] group-hover:h-full"></span>
                        <span className="absolute right-0 pr-4 duration-200 ease-out group-hover:translate-x-12">
