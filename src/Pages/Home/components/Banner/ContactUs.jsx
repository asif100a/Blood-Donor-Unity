                ...
                <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
                    <div className="grid grid-cols-1 gap-12 md:grid-cols-2 text-center md:text-start">
                        <div>
                            ...
                            <a href="#" className="mt-2 text-sm text-blue-500 dark:text-blue-400">blooddonatorUnity@gmail.com</a>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Our friendly team is here to help.</p>
                            <a href="#" className="mt-2 text-sm text-blue-500 dark:text-blue-400">Start new chat</a>
                        </div>
                        ...
                        <div>
                            ...
                            <a href="#" className="mt-2 text-sm text-blue-500 dark:text-blue-400">100 Smith Street Collingwood VIC 3066 AU</a>
                        </div>
                        ...
                        <div>
                            ...
                            <a href="#" className="mt-2 text-sm text-blue-500 dark:text-blue-400">+1 (555) 000-0000</a>
                        </div>
                    </div>
